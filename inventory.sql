...
(6, 'Shampoo', 9.00, 0, 'Bath'),
(7, 'iPhone 12 Pro', 18000.00, 3, 'Electronics'),
(8, 'Milo', 9.00, 10, 'Grocery'),
(9, 'Acer Travelmate Intel Core i3', 15000.00, 5, 'Electronics');
...
(1, 18.00, '2024-12-09 02:13:52'),
(2, 72.00, '2024-12-09 02:15:57');
...
INSERT INTO `sales_details` (`id`, `sale_id`, `product_id`, `quantity`, `price`) VALUES
(1, 1, 6, 2, 9.00),
(2, 2, 6, 8, 9.00);
